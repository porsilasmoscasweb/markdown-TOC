    ...
    with open(ruta_archivo, 'r') as archivo:
        for linea in archivo:
            ...
            if linea.startswith('#'):
                ...
                toc.append("{}- [{}](#{})".format('  ' * (nivel - 1), encabezado_texto, slug))  # Crear la línea del TOC
...
def procesar_archivos_markdown(ruta_base):
    ...
    if os.path.isfile(ruta_base) and ruta_base.endswith('.md'):
        ...
        print("La ruta proporcionada no es un archivo .md válido o un directorio: {}".format(ruta_base))
