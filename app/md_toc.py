...
def generar_toc_markdown(ruta_base, nivel=0, indice_padre="", es_raiz=False):
    ...
    for nombre in sorted(os.listdir(ruta_base)):
        ...
        if es_raiz:
            indice_actual = "{}.".format(indice_local)
        else:
            indice_actual = "{}{}.".format(indice_padre, indice_local)
        ...
        if os.path.isdir(ruta_completa):
            ...
            elementos.append("{}- {} [{}/]({}/)".format('  ' * nivel, indice_actual, nombre_formateado, ruta_absoluta))
